...
from mercedes_obd_scanner.core.config_manager import ConfigManager, EngineType, ConfigValidationError
...
class TestConfigManager:
    ...
    def test_get_all_pids(self):
        ...
        config._config_cache = {
            'common_pids': {
                'engine_rpm': {'code': '0x0C'}
            },
            'specific_pids': {
                'turbo_pressure': {'code': '0x0B'}
            }
        }
    ...
    def test_merge_configs(self):
        ...
        override_config = {
            ...
            'section3': {
                'param5': 'new_value5'        # Новая секция
            }
        }
