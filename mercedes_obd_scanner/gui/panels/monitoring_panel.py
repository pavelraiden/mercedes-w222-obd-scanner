...
class ParameterCard(ThemedFrame):
    ...
    def _create_widgets(self):
        ...
        self.icon_label = ctk.CTkLabel(
            self, text="", image=get_system_icon(self.parameter_name.lower(), (24, 24))
        )
...
class RealTimeChart(ThemedFrame):
    ...
    def _create_matplotlib_chart(self):
        ...
        # Настройка стиля
        self.ax.grid(
            True, linestyle="--", alpha=0.3, color=theme_manager.get_color("text_secondary")
        )
        self.ax.set_title(
...
class MonitoringPanel(ThemedFrame):
    ...
    def _start_monitoring(self):
        ...
        self.start_button.configure(
            text="Остановить мониторинг", image=get_action_icon("pause", (20, 20))
        )
    ...
    def _stop_monitoring(self):
        ...
        self.is_monitoring = False
        self.start_button.configure(
            text="Начать мониторинг", image=get_action_icon("play", (20, 20))
        )
