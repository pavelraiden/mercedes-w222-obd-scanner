...
Отвечает за бизнес-логику, управление состоянием и координацию
между GUI, OBD-контроллером и другими модулями.
"""
import asyncio
import os
...
from ..core import OBDController
...
PredictiveConfigPath = Path(__file__).parent.parent / "diagnostics" / "predictive_config.yaml"
