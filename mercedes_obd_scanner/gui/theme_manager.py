...
class StatusIndicator(ctk.CTkFrame):
    ...
    def update_status(self, status: str):
        ...
        status_config = {
            "connected": {"color": theme_colors["success"], "text": "Подключено"},
            "connecting": {"color": theme_colors["warning"], "text": "Подключение..."},
            "disconnected": {"color": theme_colors["error"], "text": "Отключено"},
            "error": {"color": theme_colors["error"], "text": "Ошибка"},
        }
