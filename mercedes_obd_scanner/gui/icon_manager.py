...
class IconManager:
    ...
    def create_system_icon(self, system_name: str, size: Tuple[int, int] = (24, 24), 
                          color: str = "#007AFF") -> ctk.CTkImage:
    ...
    def create_action_icon(self, action: str, size: Tuple[int, int] = (20, 20), 
                          color: str = "#007AFF") -> ctk.CTkImage:
