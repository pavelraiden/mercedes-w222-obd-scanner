...
class ConfigManager:
    ...
    def load_configs(self, base_path: str) -> None:
        ...
        try:
            ...
            self.logger.info(f"Configs loaded successfully for engine: {self._current_engine.value}")
    ...
    def _load_engine_specific_config(self) -> Dict[str, Any]:
        ...
        if self._current_engine.value.startswith("m276"):
            ...
            petrol_base = self._load_yaml_file(self._base_path / "petrol" / "base_petrol.yaml", optional=True)
            ...
            diesel_base = self._load_yaml_file(self._base_path / "diesel" / "base_diesel.yaml", optional=True)
            om642_common = self._load_yaml_file(self._base_path / "diesel" / "om642" / "common.yaml")
