...
class LicenseCrypto:
    ...
    def generate_license_key(self, prefix: str = "MOBS") -> str:
        ...
        try:
            ...
            checksum = hashlib.md5(random_data.encode()).hexdigest()[:4]
    ...
    def validate_license_key_format(self, license_key: str) -> bool:
        ...
        try:
            ...
            expected_checksum = hashlib.md5(random_data.encode()).hexdigest()[:4].upper()
    ...
    def create_license_signature(self, license_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            signature = hashlib.sha256(
                (signature_string + self.master_key).encode()
            ).hexdigest()
